...
기준은 `.claude/skills/_shared/conventions.md`를 따른다.
...
실패 원인은 `.claude/skills/_shared/conventions.md` 「Failure 원인 분류」
...
- `severity` 는 `.claude/skills/_shared/conventions.md` 「Severity 4단계」,
