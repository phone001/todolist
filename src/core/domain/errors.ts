...
export const ErrorCodes = {
  ...
  /** F-24(v1.9 신규, E-24-2). 반복 종료일이 시작일보다 이전. logic.md §18.7. */
  VALIDATION_RECURRENCE_END_BEFORE_START: 'VALIDATION_RECURRENCE_END_BEFORE_START',

  POLICY_SYSTEM_CATEGORY_DELETE: 'POLICY_SYSTEM_CATEGORY_DELETE',
  /** F-24(v1.9 신규). "이후 모두" 삭제/반복 규칙 변경 대상이 반복 회차가 아님. logic.md §18.5. */
  POLICY_NOT_RECURRING_OCCURRENCE: 'POLICY_NOT_RECURRING_OCCURRENCE',
  ...
  /** F-19 — 워치 채널 비활성/미도달. 폰 기능에는 영향 없음(베스트-에포트, NFR-12). logic §0.2 / §17.2. */
  GATEWAY_WATCH_UNAVAILABLE: 'GATEWAY_WATCH_UNAVAILABLE',
